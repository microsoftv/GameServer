...
namespace GameServerCore.Packets.Interfaces
{
    public interface IPacketNotifier
    {
        ...
        void NotifyEnterLocalVisibilityClient(IAttackableUnit unit);
        void NotifyEnterLocalVisibilityClient(int userId, IAttackableUnit unit);
        void NotifyEnterLocalVisibilityClient(int userId, uint netId);
        void NotifyEnterVisibilityClient(int userId, IChampion champion);
